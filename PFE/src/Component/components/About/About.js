...
const About = () => {
  return (
    <div className="bg-gray-200 min-h-96 pt-8 pb-16 mt-3">
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl pt-12 shadow-lg  h-72">
            ...
            <p className="text-lg font-semibold pb-2">Gestion de Patrimoine</p>
          ...
          <img src='/images/bookmark_14441992.png' alt="Search Icon" className="w-16 h-16 mb-4 mx-auto" />
            <p className="text-lg font-semibold pb-2">Assistance Juridique</p>
